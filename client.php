                                           ...
                                           <h4 class="header-title">All Clients</h4> 
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= ucwords($result['residential_address']) ?></td>
                                                    <td><div class="media-body overflow-hidden mt-1">
                                                            <h5 class="font-size-14 mb-1"><?= ucwords($result['added_by']) ?></h5>
                                                            <p class="text-muted mb-0"><?= $result['created_on'] == "" ? "None" :ucwords($result['created_on'])  ?></p>
                                                        </div></td>
                                                    <td>
                                                        <a href="client-profile.php?ref=<?= $result['client_id']?>" class="btn btn-outline-primary">View Details</a>
                                                    </td>
                                                </tr>
                                                 <?php $i++;
                                     } ?>
