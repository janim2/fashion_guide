    ...
    if(isset($_POST['add_project_btn'])){
        ...
        if($counter == 0){
            ...
            if($has_added){
                ...
                sendSms($client_number, "Hi $client_name your $type_of_work work has been added to our list of ongoing projects. Sewing Cost is GHS $sewing_charges, Delivery Cost GHS $delivery_charges. Total project cost is GHS $project_cost, Advance payment made GHS $advance_payment, Balance GHS $balance");
...
var x = setInterval(function() {
  ...
  document.getElementById("days_to_complete").innerHTML = days;
    
  // If the count down is over, write some text 
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("days_to_complete").innerHTML = "EXPIRED";
  }
}, 1000);
