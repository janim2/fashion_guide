                                   ...
                                   <div class="card">
                                       <div class="card-body">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <p class="mb-0 mt-4">Uncompleted Projects</p>
                                            </div>
                                       </div>
                                   </div>
                                </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="card">
                                        <div class="card-body">
                                             ...
                                             <h3 class="mt-3 font-size-24"><?= moneyFormat(total_delivery_costs($connect, $customer_id))?></h3>
 
                                             <div class="mt-3">
                                                 <!-- <div class="float-end">
                                                    <p class="mb-0">Expir</p>
                                                 </div> -->
 
                                                 <p class="mb-0 mt-4">Total Delivery Cost</p>
                                             </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <ul class="twitter-bs-wizard-nav">
                                                    <li class="nav-item chackout-border">
                                                        <a href="#billing-info" class="nav-link" data-toggle="tab">
                                                            <span class="step-number">01. Billing Info</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item chackout-border">
                                                        <a href="#shipping-info" class="nav-link" data-toggle="tab">
                                                            <span class="step-number">02. Shipping Info</span>
                                                        </a>
                                                    </li>
                                                    
                                                    <li class="nav-item">
                                                        <a href="#payment-info" class="nav-link" data-toggle="tab">
                                                            <span class="step-number">03. Payment Info</span>
                                                        </a>
                                                </ul>
                                                <div class="tab-content twitter-bs-wizard-tab-content">
                                                    <div class="tab-pane" id="billing-info">
                                                        <h5 class="header-title">Billing information</h5>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                                        <li class="next"><a href="#">Shipping Info <i class="mdi mdi-arrow-right ms-1"></i></a></li>
                                                                    </ul>
                                                    ...
                                                    <div class="tab-pane" id="shipping-info">
                                                        <h5 class="header-title">Shipping information</h5>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4 col-sm-6">
                                                                <div class="card border rounded active shipping-address">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <h5 class="font-size-14 mb-4 fw-bold">Address 1</h5>
                                                            ...
                                                            <div class="col-lg-4 col-sm-6">
                                                                <div class="card border rounded shipping-address">
                                                                    <div class="card-body">
                                                                        <a href="#" class="float-end ms-1">Edit</a>
                                                                        <h5 class="font-size-14 mb-4 fw-bold">Address 2</h5>
                                                        ...
                                                        <table class="table table-centered mb-0 table-nowrap">
                                                            ...
                                                            <tbody>
                                                            <tr>
                                                                <td><img src="assets/images/product/img-7.png" alt="product-img" title="product-img" class="avatar-md"></td>
                                                                <td>
                                                                    <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.html" class="text-dark">Home & Office Chair Green</a></h5>
                                                                    <p class="font-size-14 mb-0 text-muted">$240 X 03</p>
                                                                </td>
                                                                <td>$720</td>
                                                            </tr>
                                                        ...
                                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                            <li class="previous"><a href="#"><i class="mdi mdi-arrow-left me-1"></i> Billing Info</a></li>
                                                            <li class="next"><a href="#">Payment Info <i class="mdi mdi-arrow-right ms-1"></i></a></li>
                                                        </ul>


                                                    </div>
                                                    <div class="tab-pane" id="payment-info">
                                                        <h5 class="header-title">Payment information</h5>
                                                        <p class="card-title-desc">It will be as simple as occidental in fact</p>
                                                            ...
                                                            <ul class="nav nav-pills nav-justified mb-3 mt-3" id="pills-tab" role="tablist">
                                                              ...
                                                              <div class="tab-content" id="pills-tabContent">
                                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                                    <h5 class="my-4 font-size-16">Credit / Debit Payment</h5>
                                                                ...
                                                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                                                    ...
                                                                    <h5 class="my-4 font-size-16">Paypal Payment</h5>
                                                                    <div class="p-4 border">
                                                                        <form>
                                                                            <div class="mb-4">
                                                                                <label class="form-label" for="cardnameInput">Name on card</label>
                                                                ...
                                                                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                                                    ...
                                                                    <h5 class="my-4 font-size-16">Case Payment</h5>
                                                                    <div class="p-4 border">
                                                                        <form>
                                                                            <div class="mb-4">
                                                                                <label class="form-label" for="cardnameInput">Name on card</label>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <table class="table table-centered mb-0 table-nowrap">
                                                ...
                                                <tr>
                                                    <td><img src="assets/images/product/img-8.png" alt="product-img" title="product-img" class="avatar-md"></td>
                                                    <td>
                                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.html" class="text-dark">Home & Office Chair Cream</a></h5>
                                                        <p class="font-size-14 mb-0 text-muted">$225 X 02</p>
                                                ...
                                                <tr>
                                                    <td><img src="assets/images/product/img-10.png" alt="product-img" title="product-img" class="avatar-md"></td>
                                                    <td>
                                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.html" class="text-dark">Home & Office Chair Cream</a></h5>
                                                        <p class="font-size-14 mb-0 text-muted">$225 X 02</p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="assets/images/product/img-6.png" alt="product-img" title="product-img" class="avatar-md"></td>
                                                    <td>
                                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.html" class="text-dark">Home & Office Chair Black</a></h5>
                                                        <p class="font-size-14 mb-0 text-muted">$170 X 01</p>
                                                    </td>
                                                    <td>$170</td>
